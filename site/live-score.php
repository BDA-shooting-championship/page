        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div class="flex items-center gap-4">
                <div class="flex items-center -space-x-2 shrink-0">
                    <div class="w-12 h-12 rounded-full bg-white p-1.5 shadow-md border border-gray-200 flex items-center justify-center shrink-0 z-10">
                        <picture>
                    ...
                    <div class="w-12 h-12 rounded-full bg-white p-1.5 shadow-md border border-gray-200 flex items-center justify-center shrink-0 z-0">
                        <picture>
                ...
                <div>
                    <div class="flex items-center gap-2">
                        ...
                        <h1 class="font-display text-2xl sm:text-3xl font-bold text-gray-900 tracking-wide">
                            LIVE SCORE
                        </h1>
                    </div>
                </div>
            ...
            <div class="flex items-center gap-3">
                <span class="text-xs text-gray-400 font-mono hidden sm:inline" x-text="'Update: ' + lastUpdated"></span>
                <div class="flex items-center gap-2 bg-white px-3 py-2 rounded-xl border border-gray-200 text-xs">
                    ...
                    <button type="button" @click="toggleAutoRefresh()" 
                            :class="autoRefresh ? 'bg-emerald-600 text-white' : 'bg-gray-200 text-gray-700'"
                            class="px-2 py-0.5 rounded text-[11px] font-bold uppercase transition"
                            x-text="autoRefresh ? 'Aktif' : 'Off'"></button>
                </div>
        ...
        <div x-show="activeTab === 'dueling'" x-transition>
            ...
            <template x-if="groupedDuelingMatches.length === 0">
                <div class="bg-white rounded-2xl p-10 text-center border border-gray-200 shadow-sm">
                    <p class="font-semibold text-gray-600">Belum ada bagan pertandingan dueling plat.</p>
                </div>
            </template>
