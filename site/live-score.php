                    ...
                    <table class="w-full text-left text-xs sm:text-sm">
                        <thead class="bg-gray-100 uppercase font-bold text-gray-600 tracking-wider border-b border-gray-200">
                            <tr>
                                ...
                                <th class="py-3.5 px-3 text-center font-bold text-copper-700">Jml X</th>
                                <th class="py-3.5 px-4 text-center font-bold text-copper-700 bg-copper-50/50">Total Skor</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200">
                            <template x-for="(score, index) in presisiScores" :key="score.registration_id || index">
                                <tr :class="{
                                    ...
                                    <td class="py-3 px-4 font-mono font-bold text-copper-600" x-text="score.no_peserta || '-'"></td>
                                    <td class="py-3 px-4">
                                        <span class="font-bold text-gray-900" x-text="score.nama"></span>
                                    </td>
                                    <td class="py-3 px-4 text-gray-600 text-xs" x-text="score.satuan || '-'"></td>
                                    
                                    <!-- Seri 1 - 10 -->
                                    <td class="py-3 px-2 text-center font-mono text-xs text-gray-600" x-text="score.seri_1"></td>
                                    <td class="py-3 px-2 text-center font-mono text-xs text-gray-600" x-text="score.seri_2"></td>
                                    <td class="py-3 px-2 text-center font-mono text-xs text-gray-600" x-text="score.seri_3"></td>
                                    <td class="py-3 px-2 text-center font-mono text-xs text-gray-600" x-text="score.seri_4"></td>
                                    <td class="py-3 px-2 text-center font-mono text-xs text-gray-600" x-text="score.seri_5"></td>
                                    <td class="py-3 px-2 text-center font-mono text-xs text-gray-600" x-text="score.seri_6"></td>
                                    <td class="py-3 px-2 text-center font-mono text-xs text-gray-600" x-text="score.seri_7"></td>
                                    <td class="py-3 px-2 text-center font-mono text-xs text-gray-600" x-text="score.seri_8"></td>
                                    <td class="py-3 px-2 text-center font-mono text-xs text-gray-600" x-text="score.seri_9"></td>
                                    <td class="py-3 px-2 text-center font-mono text-xs text-gray-600" x-text="score.seri_10"></td>
                                    
                                    <!-- X Count -->
                                    <td class="py-3 px-3 text-center font-mono font-bold text-copper-600" x-text="score.x_count + 'x'"></td>
                                    
                                    <!-- Total Score -->
                                    <td class="py-3 px-4 text-center font-mono font-extrabold text-base text-gray-900 bg-copper-50/30" x-text="score.total_score"></td>
                                </tr>
                            </template>
                        ...
                        <template x-for="match in round.matches" :key="match.id">
                            <div class="bg-white rounded-xl p-5 border border-gray-200 shadow-md relative overflow-hidden">
                                ...
                                <div class="flex justify-between items-center p-2.5 rounded-lg mb-2 transition"
                                     :class="match.winner_id && match.winner_id === match.participant_1_id ? 'bg-green-50 border border-green-300' : 'bg-gray-50'">
                                    ...
                                    <div class="text-right shrink-0">
                                        <span class="font-mono font-bold text-sm" 
                                              :class="match.time_1 ? 'text-gray-900' : 'text-gray-400'"
                                ...
                                <div class="flex justify-between items-center p-2.5 rounded-lg transition"
                                     :class="match.winner_id && match.winner_id === match.participant_2_id ? 'bg-green-50 border border-green-300' : 'bg-gray-50'">
                                    <div class="truncate mr-2">
                                        <div class="flex items-center gap-1.5">
                                    ...
                                    <div class="text-right shrink-0">
                                        <span class="font-mono font-bold text-sm" 
                                              :class="match.time_2 ? 'text-gray-900' : 'text-gray-400'"
