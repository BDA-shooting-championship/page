...
<div class="py-8 bg-gray-50 dark:bg-gray-900 min-h-screen" x-data="adminScoresApp()" x-init="initData()">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8 pb-6 border-b border-gray-200 dark:border-gray-800">
            <div>
                <div class="flex items-center gap-2">
                    <span class="px-2.5 py-0.5 rounded-full text-xs font-bold bg-copper-100 dark:bg-copper-900/30 text-copper-700 dark:text-copper-400 uppercase tracking-wider">
                        Admin Control Panel
                    </span>
                </div>
                <h1 class="font-display text-3xl font-bold mt-1 text-gray-900 dark:text-white">
            ...
            <div class="flex items-center gap-3">
                <a href="/admin/index.php" class="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-xs font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition flex items-center gap-1.5 shadow-sm">
        ...
        <div x-show="alertMessage" x-cloak class="mb-6 p-4 rounded-xl border text-xs font-semibold flex items-center justify-between"
             :class="alertType === 'success' ? 'bg-green-50 dark:bg-green-950/30 border-green-200 dark:border-green-800 text-green-700 dark:text-green-300' : 'bg-red-50 dark:bg-red-950/30 border-red-200 dark:border-red-800 text-red-700 dark:text-red-300'">
            <span x-text="alertMessage"></span>
            <button @click="alertMessage = null" class="text-gray-400 hover:text-gray-600">&times;</button>
        </div>

        <!-- Navigation Tabs -->
        <div class="flex border-b border-gray-200 dark:border-gray-800 mb-6 space-x-4">
            <button @click="activeTab = 'presisi'" 
                    :class="activeTab === 'presisi' ? 'border-copper-600 text-copper-600 dark:text-copper-400 border-b-2 font-bold' : 'border-transparent text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'"
            ...
            <button @click="activeTab = 'dueling'" 
                    :class="activeTab === 'dueling' ? 'border-copper-600 text-copper-600 dark:text-copper-400 border-b-2 font-bold' : 'border-transparent text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'"
                    class="py-3 px-4 font-display text-base transition flex items-center gap-2">
        ...
        <div x-show="activeTab === 'presisi'" x-transition>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                <div class="text-xs text-gray-500">
                    <p class="font-semibold text-gray-700 dark:text-gray-300">Panduan Pengisian:</p>
                ...
                <button type="button" @click="syncVerifiedParticipants()" :disabled="isSyncing"
                        class="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 text-xs font-semibold rounded-xl transition flex items-center gap-1.5 shrink-0 shadow-sm">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-xs">
                        <thead class="bg-gray-100 dark:bg-gray-900/80 uppercase font-bold text-gray-600 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700">
                            <tr>
                                ...
                                <th class="py-3 px-3 text-center w-16 font-bold bg-copper-50/50 dark:bg-copper-900/20">Total</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            <template x-for="(item, index) in presisiList" :key="item.id || item.registration_id">
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/20 transition">
                                    ...
                                    <td class="py-2 px-3 font-mono font-bold text-copper-600 dark:text-copper-400" x-text="item.no_peserta || '-'"></td>
                                    <td class="py-2 px-3">
                                    ...
                                    <template x-for="i in 10" :key="i">
                                        <td class="py-2 px-1 text-center">
                                            <input type="number" min="0" max="10" 
                                                   ...
                                                   class="w-10 text-center py-1 rounded bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 text-xs font-mono font-bold focus:ring-1 focus:ring-copper-500 focus:outline-none">
                                        </td>
                                    </template>
                                    ...
                                    <td class="py-2 px-2 text-center">
                                        <input type="number" min="0" max="10" 
                                               ...
                                               class="w-12 text-center py-1 rounded bg-copper-50/50 dark:bg-copper-950/30 border border-copper-300 dark:border-copper-700 text-xs font-mono font-bold text-copper-700 dark:text-copper-400 focus:ring-1 focus:ring-copper-500 focus:outline-none">
                                    </td>

                                    <!-- Total Score -->
                                    <td class="py-2 px-3 text-center font-mono font-extrabold text-sm text-gray-900 dark:text-white bg-copper-50/30 dark:bg-copper-900/10" x-text="item.total_score"></td>
        ...
        <div x-show="activeTab === 'dueling'" x-transition>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-200 dark:border-gray-700 mb-8">
                ...
                <form @submit.prevent="createDuelingMatch" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-xs">
                    <div>
                        <label class="block font-semibold text-gray-700 dark:text-gray-300 mb-1">Babak Pertandingan</label>
                        <select x-model="newMatch.round_name" required class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-xs">
                    ...
                    <div>
                        <label class="block font-semibold text-gray-700 dark:text-gray-300 mb-1">Nomor Match</label>
                        <input type="number" min="1" x-model.number="newMatch.match_number" required placeholder="1" 
                               class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-xs">
                    </div>

                    <div>
                        <label class="block font-semibold text-gray-700 dark:text-gray-300 mb-1">Peserta 1</label>
                        <input type="text" x-model="newMatch.participant_1_name" placeholder="Nama Peserta 1" required
                               class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-xs">
                    </div>

                    <div>
                        <label class="block font-semibold text-gray-700 dark:text-gray-300 mb-1">Peserta 2</label>
                    ...
                    <table class="w-full text-left text-xs">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            <template x-for="match in duelingList" :key="match.id">
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/20 transition">
                                    <td class="py-2.5 px-3 font-semibold text-gray-900 dark:text-white" x-text="match.round_name"></td>
                                    <td class="py-2.5 px-2 text-center font-mono font-bold text-copper-600" x-text="match.match_number"></td>
                                    
                                    <!-- Participant 1 -->
                                    <td class="py-2.5 px-3">
                                        <input type="text" x-model="match.participant_1_name" class="w-full px-2 py-1 rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-xs">
                                    </td>
                                    <td class="py-2.5 px-2 text-center">
                                        <input type="number" step="0.001" x-model.number="match.time_1" placeholder="0.000" class="w-20 text-center px-1.5 py-1 rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-xs font-mono">
                                    </td>

                                    <!-- Participant 2 -->
                                    <td class="py-2.5 px-3">
                                        <input type="text" x-model="match.participant_2_name" class="w-full px-2 py-1 rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-xs">
                                    </td>
                                    <td class="py-2.5 px-2 text-center">
                                        <input type="number" step="0.001" x-model.number="match.time_2" placeholder="0.000" class="w-20 text-center px-1.5 py-1 rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-xs font-mono">
                                    </td>

                                    <!-- Winner Selector -->
                                    <td class="py-2.5 px-3">
                                        <select x-model="match.winner_id" class="w-full px-2 py-1 rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-xs">
                                    ...
                                    <td class="py-2.5 px-3 text-center">
                                        <select x-model="match.match_status" class="w-full px-1.5 py-1 rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-900 text-xs font-semibold">
