...
>
    <div class="max-w-7xl mx-auto">
        ...
        <div x-show="activeTab === 'scores'" x-transition>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-5 mb-6 shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h2 class="font-display text-xl sm:text-2xl font-bold text-gray-900">
                        Manajemen &amp; Input Skor
                    </h2>
                </div>
            ...
            <div x-show="scoresSubTab === 'dueling'" x-transition>
                ...
                <div class="bg-white rounded-2xl shadow-sm p-4 sm:p-5 border border-gray-200 mb-6">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        <div class="flex items-center gap-2">
                            <h3 class="font-display text-lg font-bold text-gray-900" x-text="'Bagan Turnamen Dueling Plat (' + (duelingCategory === 'bda' ? 'Khusus BDA Korbrimob' : 'Kelas Umum POLRI') + ')'"></h3>
                            <span class="text-xs text-gray-500 font-semibold" x-text="filteredDuelingList.length + ' Match'"></span>
                        </div>
                        ...
                        <div class="flex flex-wrap items-center gap-2.5 shrink-0">
                            <div class="flex items-center gap-1.5 bg-gray-50 px-3 py-1.5 rounded-xl border border-gray-300">
                                ...
                                <div class="flex flex-wrap items-center gap-1 border-l border-gray-200 pl-2">
                                    ...
                                    <button type="button" @click="bracketParticipantCount = 24" :class="bracketParticipantCount === 24 ? 'bg-copper-600 text-white font-bold' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'" class="px-2 py-0.5 rounded text-[11px] transition">24</button>
                                    ...
                                    <button type="button" @click="bracketParticipantCount = 55" :class="bracketParticipantCount === 55 ? 'bg-copper-600 text-white font-bold' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'" class="px-2 py-0.5 rounded text-[11px] transition">55</button>
                                    ...
                                    <button type="button" @click="bracketParticipantCount = 67" :class="bracketParticipantCount === 67 ? 'bg-copper-600 text-white font-bold' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'" class="px-2 py-0.5 rounded text-[11px] transition">67</button>
                                </div>
                            </div>
