...
<!-- Navbar -->
<nav class="fixed top-0 w-full z-50 transition-all duration-300 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm" x-data="{ scrolled: false }" @scroll.window="scrolled = window.scrollY > 50">
